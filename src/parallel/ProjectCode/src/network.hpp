...
//public:
  ...
  void convertToArray(double* retarr);

  void convertFromArray(double* arr);

  virtual void train_network(int numEpochs, int batchSize, double eta, int rank, int num_procs, bool test);
